...
export const Route = createFileRoute("/journal/")({
  head: () => ({
    meta: [
      { title: "Journal — Tuk Tuk 24 Travel Stories & Portugal Guides" },
      {
        name: "description",
        content:
          "Read Tuk Tuk 24's Portugal journal with practical guides, Lisbon tips, Sintra weekend ideas and coastal travel advice.",
      },
    ...
    <div className="min-h-screen bg-paper text-ink overflow-x-clip">
      ...
      <section className="pt-[94px] md:pt-[118px] pb-10 md:pb-14 bg-cloud/45">
        <div className="container-x">
          <p className="eyebrow text-gold mb-3">Tuk Tuk 24 Journal</p>
